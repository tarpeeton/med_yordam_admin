  ...
  return (
    <html lang={locale}>
      <head>
        ...
        <meta property="og:description" content="Ваш надежный онлайн-помощник в сфере здравоохранения. Получите доступ к консультациям врачей, полезным советам по здоровью и проверенным медицинским ресурсам." />
        <meta property="og:image" content="/favicon.ico" />
        <meta property="og:image:type" content="favicon-96x96.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="https://med-yordam-eight.vercel.app/ru" />
